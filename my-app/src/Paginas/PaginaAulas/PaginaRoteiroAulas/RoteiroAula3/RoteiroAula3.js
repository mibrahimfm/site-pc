...
function RoteiroAula3() {
    return(
        <div>
            <header>
                <h1 className="title">Aula 3 - Introdução aos Laços de Repetição</h1>
            </header>
            <body className="body">
                <TabelaAula3></TabelaAula3>
                <a target="_blank" rel="noreferrer" href="https://drive.google.com/drive/folders/17-V1mCREFhAi_u89h74vRpGdiKY_aUY2">
                    Drive com todos os materiais da aula 3
                </a>

                <p>Nesta aula os alunos aprendem sobre os laços de repetição e a utilizá-los para simplificar
            algoritmos escritos em uma linguagem de programação em bloco.</p>
              
            <h3>Descrição da Aula</h3>
            <p>
            Esta é a primeira aula do curso com atividades conduzidas exclusivamente de forma
            ...
            individual, que o professor terá acesso, para cada aluno adicionado.</i>
            </p>
            <h5>Revisão</h5>
            <p>
            Antes do professor apresentar o tópico principal da terceira aula, é recomendado uma
            revisão do conteúdo visto e a atividade Programando em Papel conduzida na aula
            anterior. A fim de conduzir a revisão, sugerimos a ferramenta Kahoot! que permite
            que quizzes online e gamificados sejam conduzidos com a turma de maneira divertida,
            instigando uma competição saudável entre os alunos. O <a href="https://create.kahoot.it/share/kahoot-1-algoritmos-e-programando-em-papel/b77eb400-e955-4ef0-80b6-b5787270369e">kahoot </a> 
            criado por nós  pode ser acessado através do link no pé da página e ele pode ser copiado, adaptado e modificado
            pelo professor caso necessário. Durante a condução do kahoot, recomendamos que
            explicações sejam dadas logo após os alunos responderem cada pergunta. A ferramenta
            exibe a quantidade de respostas que cada alternativa recebeu e a resposta correta.
            ...
            blocos que os alunos utilizarão na aula, acesse a lição Labirinto: Sequência do Curso 2.
            ...
            <h5>Lição Labirinto: Ciclos</h5>
            <p>Após a introdução do tópico da aula, o professor deve compartilhar com os alunos
            a URL da seção da turma e as credenciais para eles acessarem a seção. Na página
            ...
            utilização eficiente dos blocos. Explique aos alunos que após a resolução de um desafio,
            ...
            devido à complexidade geral da lição, a grande maioria dos alunos pode não finalizar
            a lição em apenas uma aula, logo recomendados que o professor dê continuidade à
