import './RoteiroAula6.css';
import TabelaAula6 from './TabelaAula6';

function RoteiroAula6() {
    return(
        <div>
            <header>
                <h1 className="title">Aula 6 - Anime o seu nome</h1>
            </header>
            <body className="body">
                <TabelaAula6></TabelaAula6>
                <a target="_blank" rel="noreferrer" href="https://drive.google.com/drive/folders/14ecl_xTY0SC5HJXjFIS_YlOYBm3d859C">
                    Drive com todos os materiais da aula 6
                </a>

                <p>Nesta aula os alunos continuam praticando comandos simples do Scratch para manipular a aparência e animar as letras de seus nomes.</p>
              
            <h3>Descrição da Aula</h3>
            <p>
            A Aula 6 está estruturada em quatro partes: Revisão, Blocos de Eventos, Anime seu
            Nome e Apresentação e votação.
            </p>
            <h5>Revisão</h5>
            <p>
            No momento inicial da aula, recomendamos também que os tópicos abordados na aula
            anterior sejam revisados com a turma. Criamos o <a href="https://create.kahoot.it/share/kahoot-3-plano-cartesiano-e-scratch/fae2070f-15cd-4968-a8ff-8487b1ff0d31">Kahoot 3 - Plano Cartesiano e Scratch </a>
            para que o professor faça esta revisão. Ele contém exercícios de identificação de
            pontos similares àqueles da aula anterior e questões sobre alguns blocos de movimento
            do Scratch. Caso o professor não queira fazer a revisão através do Kahoot, também
            incluímos slides de revisão na Aula 6 - Apresentação.
            </p>
            
            <h5>Blocos de Eventos</h5>
            <p>
            Após conduzida a revisão com os alunos, o professor apresenta os blocos de eventos aos
            alunos e como eles são utilizados no Scratch. Deve ser explicado que estes blocos são
            utilizados para que scripts sejam executados apenas quando certos eventos ocorrem.
            Exemplos de eventos devem ser dados para que os alunos realmente entendam o que
            ...
            <h5>Anime seu Nome</h5>
            <p>
            Para a parte prática da aula conduza a atividade Anime seu Nome. Nesta atividade,
            ...
            será realizada para que os alunos escolham os projetos que eles mais gostaram. A única
            ...
            <br></br>
                ...
                exibi-los para a turma através do projetor de tela. Uma competição para ver quem criou as animações
            ...
            roteiro contém diversas opções de animações que eles podem implementar para cada
            ...
            <h5>Apresentação e votação</h5>
            <p>
            Caso haja tempo, no fim da aula o professor conduz a apresentação e votação dos pro-
            jetos criados pelos alunos. Peça que todos os alunos salvem, compartilhem e adicionem
            seus projetos ao estúdio da turma, que foi previamente criado. Demonstre como eles
            devem fazer isso através do projetor de tela para que eles possam entender como fazer
